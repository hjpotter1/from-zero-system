        ...
        <div>
          <Form layout='horizontal' onSubmit={this.handleSubmit}>
            ...
            <Form.Item label='项目' {...styles.formItem2Col}>
              {getFieldDecorator('project')(<Input placeholder='' />)}
            </Form.Item>

            <Form.Item label='导购员' {...styles.formItem2Col}>
              {getFieldDecorator('shop_guide')(
                <Input
                  placeholder={this.state.can_shop_guide ? '' : '不能输入'}
                  disabled={this.state.can_shop_guide ? false : true}
                />
              )}
            </Form.Item>

            <Form.Item label='老师' {...styles.formItem2Col}>
              {getFieldDecorator('teacher')(<Input placeholder='' />)}
            </Form.Item>

            <Form.Item label='财务情况' {...styles.formItem2Col}>
              {getFieldDecorator('financial')(<Input placeholder='' />)}
            </Form.Item>

            <Form.Item label='备注1' {...styles.formItemLayout}>
              {getFieldDecorator('remarks1')(<Input placeholder='' />)}
            </Form.Item>

            <Form.Item label='收钱吧详情' {...styles.formItem2Col}>
              {getFieldDecorator('collect_money')(<Input placeholder='' />)}
            </Form.Item>

            <Form.Item label='备注2' {...styles.formItemLayout}>
              {getFieldDecorator('remarks2')(<Input placeholder='' />)}
            </Form.Item>
          </Form>
        </div>
      </Modal>
