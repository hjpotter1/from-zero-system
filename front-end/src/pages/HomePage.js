...
var tmp = {
  ...
  teacher: '王大锤',
  financial: '图片1',
  remarks1: 'B6A9B5A5BAC5B2E9D1AF',
  collect_money: '图片2',
  remarks2: 'B6A9B5A5BAC5B2E9D1AF',
}
...
class HomePage extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log('columns' + columns) //加了一列的
  ...
  removeData(id) {
    HttpUtil.get(ApiUtil.API_STAFF_DELETE + id).then((x) => {
      console.log('删除了')
      this.getData()
    })
  }
...
//     this.getMyColumns = this.getMyColumns.bind(this)
//   }
//   mAllData = []
//   columns2 = [] //定义S
//   state = {
